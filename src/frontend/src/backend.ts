...
import type { Category as _Category, Order as _Order, OrderItem as _OrderItem, OrderStatus as _OrderStatus, Product as _Product, ShippingAddress as _ShippingAddress, StripeSessionStatus as _StripeSessionStatus, Time as _Time, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: string, arg1: string, arg2: ShippingAddress, arg3: Array<OrderItem>, arg4: string): Promise<string> {
        if (this.processError) {
            try {
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "bedroom" in value ? Category.bedroom : "bathroom" in value ? Category.bathroom : "kitchen" in value ? Category.kitchen : "livingRoom" in value ? Category.livingRoom : "outdoor" in value ? Category.outdoor : value;
}
